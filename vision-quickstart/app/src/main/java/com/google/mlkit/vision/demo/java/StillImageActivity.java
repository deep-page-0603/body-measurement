...
public final class StillImageActivity extends AppCompatActivity {
  ...
  private static final String POSE_DETECTION = "Body Measurements";
  private static final String SELFIE_SEGMENTATION = "Body Segmentation";
  ...
  private static final String SIZE_SCREEN = "Aki W."; // Match screen width
  ...
  protected void onActivityResult(int requestCode, int resultCode, Intent data) {
    if (requestCode == REQUEST_IMAGE_CAPTURE && resultCode == RESULT_OK) {
      ...
      Toast.makeText(this, "img: " + imageUri, Toast.LENGTH_LONG).show();
      tryReloadAndDetectInImage();
    } else {
